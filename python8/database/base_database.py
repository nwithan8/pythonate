...
from python8.internal.errors import MissingSupportError
...
class SQLAlchemyDatabase:
    """
    Base class for an SQLite-based database using SQLAlchemy ORM
    """
    ...
    def __init__(self, sqlite_file: str):
        try:
            ...
            raise MissingSupportError(extension=DATABASE_MODULE)
    ...
    @false_if_error
    def _delete_entry(self, entry) -> bool:
